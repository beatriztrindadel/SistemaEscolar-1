  ...
  <div class="flex-none w-full max-w-full px-3">
    <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
      <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
        ...
        <a href="<?php echo route_to('teachers.new'); ?>" class="btn" style="background:rgb(0, 0, 0); color: white; border-radius: 50px;">
              ...
              <?php foreach ($teachers as $teacher): ?>
                <tr>
                  <td class="align-middle pb-0">
                    <div>
                    <a href="<?= base_url('teachers/show/' . $teacher->code); ?>" 
   ...
   Detalhes
                  ...
                  <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                    <div class="d-flex items-center justify-center">
                      <div>
                        <h6 class="mb-0 text-sm"><?php echo htmlspecialchars($teacher->name, ENT_QUOTES, 'UTF-8'); ?></h6>
                      </div>
                    </div>
                  </td>
                  ...
                  <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                    <div class="d-flex items-center justify-center">
                      <div>
                        <h6 class="mb-0 text-sm"><?php echo htmlspecialchars($teacher->email, ENT_QUOTES, 'UTF-8'); ?></h6>
                      </div>
                    </div>
                  </td>
                  ...
                  <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                    <div class="d-flex items-center justify-center">
                      <div>
                        <h6 class="mb-0 text-sm"><?php echo htmlspecialchars($teacher->cpf, ENT_QUOTES, 'UTF-8'); ?></h6>
                      </div>
                    </div>
                  </td>
                </tr>
