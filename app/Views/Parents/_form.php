...
<div class="row mt-4">
    ...
    <div class="col-md-2">
        <div class="form-floating mb-3">
            <input type="text" class="form-control cep" placeholder="CEP válido" name="postal_code" value="<?php echo old('postal_code', $parent->address->postal_code); ?>" id="postal_code">
    ...
    <div class="col-md-4">
        <div class="form-floating mb-3">
            <input type="text" class="form-control" placeholder="Estado" name="state" value="<?php echo old('state', $parent->address->state); ?>" id="state">
