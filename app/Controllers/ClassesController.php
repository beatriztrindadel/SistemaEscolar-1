...
class ClassesController extends BaseController
{
    ...
    public function create(): RedirectResponse
    {
        ...
        if (!$success) {
            return redirect()->back()->with('danger', "Ocorreu um erro na criação da turma");
        }

        $createdClass = $this->classModel->find($this->classModel->getInsertID());

        return redirect()->route('classes.show', [$createdClass->code])->with('success', "Sucesso!");
    }
    ...
    public function update(string $code): RedirectResponse
    {
        ...
        if (!$success) {
            return redirect()->back()->with('danger', "Ocorreu um erro na atualização turma");
        }


        return redirect()->route('classes.show', [$class->code])->with('success', "Sucesso!");
    }
    ...
    public function destroy(string $code): RedirectResponse
    {
        ...
        return redirect()->route('classes')->with('success', "Sucesso!");
    }
